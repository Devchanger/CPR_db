...
class ServiceTransactionalTest {
    ...
    void transactionalAnnotationsPresent() throws Exception {
        Expect[] expects = {
            ...
            new Expect("StudentService", "createStudent", false),
            new Expect("StudentService", "ensureAccount", false),
            new Expect("StudentService", "resetPassword", false),
            new Expect("StudentService", "deleteStudent", false),
            new Expect("StudentService", "updateStudentStatus", false),
            new Expect("StudentService", "getStudentList", true),
            new Expect("StudentService", "getStudentById", true),
            new Expect("NotificationService", "create", false),
            new Expect("NotificationService", "update", false),
            new Expect("NotificationService", "delete", false),
            new Expect("NotificationService", "list", true),
            new Expect("NotificationService", "getById", true),
